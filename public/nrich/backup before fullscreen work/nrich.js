var nrich = {
	...
	splash: function(pallette, useClouds) {
		...
		nrich.settings.backgroundcolour = '#a2c';
	...
	permittedSettings: function(settings) {
		...
		$(".full-screen-100").click(function() {

			console.log("settings.url");
			console.log(settings.url);

			// var urlString = settings.url + "?";
			var urlString = "scaleframe_100.html?";
			var settingCount = 0;
		...
		$(".full-screen-150").click(function() {

			console.log("settings.url");
			console.log(settings.url);

			// var urlString = settings.url + "?";
			var urlString = "scaleframe_150.html?";
			var settingCount = 0;
		...
		$(".full-screen-200").click(function() {

			console.log("settings.url");
			console.log(settings.url);

			// var urlString = settings.url + "?";
			var urlString = "scaleframe_200.html?";
			var settingCount = 0;
				...
				if ($("#nmenu").is(".prepared")) {
					...
					$.each(settings.options, function(i, s) {
						...
						$.each(s, function(j, o) {
							...
							if (o == "[form]") {
								...
								optionHtml = "<input class='nrich-settings-form' val='abc' />";
							...
							if (settings.current[i] == o) {
								...
								settingHtml += "<div class='nrich-setting-option active'>" + optionHtml + "</div>";
							} else {

								settingHtml += "<div class='nrich-setting-option'>" + optionHtml + "</div>";
							}
						})
					...
					$(".nrich-setting").each(function(i, s) {
						...
						$(settingOptions).click(function() {
							...
							settings.current[settingName] = nrich.nastyname($(this).html());
							console.log(settings.current);
